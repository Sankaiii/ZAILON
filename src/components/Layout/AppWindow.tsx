...
export function AppWindow() {
  ...
  // In Tauri: fill the native window (no wrapper box needed)
  if (isTauri) {
    return (
      <div
        className="flex flex-col overflow-hidden w-screen h-screen"
  ...
  // In browser: show as centered window with shadow
  return (
    <div
